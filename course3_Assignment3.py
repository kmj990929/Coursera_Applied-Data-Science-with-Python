...
def answer_four():
    ...
    model.fit(X_train, y_train)
    predict = model.decision_function(X_test)>-220
...
def answer_five():
    ...
    precision2, recall2, thresholds2 = roc_curve(y_test,predict)
    
    plt.plot(recall, precision)
    plt.plot(recall2, precision2)
    plt.legend(['recall', 'roc'])
    plt.show()"""
...
def answer_six():    
    ...
    result = np.array([clf.cv_results_['mean_test_score']])
